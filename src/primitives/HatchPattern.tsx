...
export const HatchPattern = (props: {
    ...
    return <View
        ...
        <Svg width="100%" height="100%">
            <Defs>
                <Pattern id="diagonalHatch" width={theme.scale * 4} height="10" patternTransform="rotate(45 0 0)" patternUnits="userSpaceOnUse">
                    <Line x1="0" y1="0" x2="0" y2="10" stroke={color} strokeWidth={theme.scale * 4} />
                </Pattern>
            </Defs>
